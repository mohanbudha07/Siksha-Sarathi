...
CREATE TABLE IF NOT EXISTS teacher_interventions (
    ...
    baseline_quiz_accuracy DECIMAL(6,2) NULL,
    baseline_quiz_questions INT NOT NULL DEFAULT 0,
    baseline_paper_average DECIMAL(6,2) NULL,
    baseline_paper_assessments INT NOT NULL DEFAULT 0,
    baseline_attendance_percent DECIMAL(6,2) NULL,
    baseline_attendance_days INT NOT NULL DEFAULT 0,
